...
export const OBJECTIVES: Objective[] = [
  {
    id: 'obj_capture_1',
    label: 'Captura una ciudad',
    badgeId: 'b_conq_jr',
    trigger: 'beacon_capture',
    target: 1,
  },
  {
    id: 'obj_coins_10',
    label: 'Recolecta 10 monedas',
    badgeId: 'b_caza',
    trigger: 'coins_collected',
    target: 10,
  },
  {
    id: 'obj_kills_3',
    label: 'Elimina 3 enemigos',
    badgeId: 'b_sicario',
    trigger: 'kills',
    target: 3,
  },
  ...
  {
    id: 'obj_all_beacons',
    label: 'Captura todos los beacons',
    badgeId: 'b_tlatoani',
    trigger: 'all_beacons_captured',
    target: 0,
  },
];
...
export const BADGES: Badge[] = [
  {
    id: 'b_conq_jr',
    name: 'Conquistador Junior',
    icon: '🏴',
    xpReward: 50,
    description: 'Captura tu primera ciudad',
  },
  {
    id: 'b_caza',
  ...
  },
  {
    ...
    icon: '💎',
    xpReward: 150,
    description: 'Recolecta 50 monedas en total',
  },
  {
    id: 'b_tlatoani',
    name: 'Tlatoani',
    icon: '👑',
    xpReward: 200,
    description: 'Captura todos los beacons del mapa',
  },
];
